export const config: WebdriverIO.Config = {
    ...
    capabilities: [{
        ...
        platformName: 'roku',
        'appium:deviceName': 'localRoku',
        'appium:ip': 'roku.ip.add.ress',
        'appium:password': 'rokuDevPassword',
        'appium:app': 'builds/SearchView.zip',
    ...
    services: [
        ['appium', {
            logPath: 'logs/appium/appium.log',
        }]
    ],
    ...
    reporters: [['allure', {outputDir: 'logs/allure-results'}]],
